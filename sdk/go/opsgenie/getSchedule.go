...
//			_, err := opsgenie.GetSchedule(ctx, &opsgenie.LookupScheduleArgs{
...
func LookupScheduleOutput(ctx *pulumi.Context, args LookupScheduleOutputArgs, opts ...pulumi.InvokeOption) LookupScheduleResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupScheduleResultOutput, error) {
			...
			return ctx.InvokeOutput("opsgenie:index/getSchedule:getSchedule", args, LookupScheduleResultOutput{}, options).(LookupScheduleResultOutput), nil
