...
class EmailIntegrationArgs:
    def __init__(__self__, *,
                 email_username: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] email_username: The username part of the email address. It must be unique for each integration.
        :param pulumi.Input[builtins.bool] enabled: A Member block as documented below.
        ...
        :param pulumi.Input[builtins.str] owner_team_id: Owner team id of the integration.
    ...
    def email_username(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def email_username(self, value: pulumi.Input[builtins.str]):
...
class _EmailIntegrationState:
    def __init__(__self__, *,
                 email_username: Optional[pulumi.Input[builtins.str]] = None,
                 enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ignore_responders_from_payload: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 owner_team_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="emailUsername")
    def email_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The username part of the email address. It must be unique for each integration.
        """
        return pulumi.get(self, "email_username")
    ...
    @email_username.setter
    def email_username(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "email_username", value)
...
class EmailIntegration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            owner_team_id: Optional[pulumi.Input[builtins.str]] = None,
            responders: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EmailIntegrationResponderArgs', 'EmailIntegrationResponderArgsDict']]]]] = None,
            suppress_notifications: Optional[pulumi.Input[builtins.bool]] = None) -> 'EmailIntegration':
        """
    ...
    @property
    @pulumi.getter(name="emailUsername")
    def email_username(self) -> pulumi.Output[builtins.str]:
        """
        The username part of the email address. It must be unique for each integration.
        """
        return pulumi.get(self, "email_username")
