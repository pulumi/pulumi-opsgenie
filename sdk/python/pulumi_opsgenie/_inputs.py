...
class AlertPolicyFilterConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] expected_value: User defined value that will be compared with alert field according to the operation. Default: empty string
        :param pulumi.Input[_builtins.str] key: If `field` is set as extra-properties, key could be used for key-value pair
        :param pulumi.Input[_builtins.bool] not_: Indicates behaviour of the given operation. Default: `false`
        :param pulumi.Input[_builtins.int] order: Order of the condition in conditions list
        """
...
if not MYPY:
    class AlertPolicyTimeRestrictionRestrictionArgsDict(TypedDict):
        end_hour: pulumi.Input[_builtins.int]
        """
        Ending hour of restriction.
        """
        end_min: pulumi.Input[_builtins.int]
        """
        ...
        """
        start_min: pulumi.Input[_builtins.int]
        """
...
class AlertPolicyTimeRestrictionRestrictionArgs:
    def __init__(__self__, *,
                 ...
                 start_min: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] end_hour: Ending hour of restriction.
        :param pulumi.Input[_builtins.int] end_min: Ending minute of restriction on defined `end_hour`
        :param pulumi.Input[_builtins.int] start_hour: Starting hour of restriction.
        :param pulumi.Input[_builtins.int] start_min: Staring minute of restriction on defined `start_hour`
        """
    ...
    def end_hour(self) -> pulumi.Input[_builtins.int]:
        """
        Ending hour of restriction.
        """
    ...
    @end_hour.setter
    def end_hour(self, value: pulumi.Input[_builtins.int]):
        pulumi.set(self, "end_hour", value)

    @_builtins.property
    @pulumi.getter(name="endMin")
    def end_min(self) -> pulumi.Input[_builtins.int]:
        """
        Ending minute of restriction on defined `end_hour`
        """
    ...
    @end_min.setter
    def end_min(self, value: pulumi.Input[_builtins.int]):
    ...
    def start_min(self) -> pulumi.Input[_builtins.int]:
        """
        Staring minute of restriction on defined `start_hour`
        """
...
class AlertPolicyTimeRestrictionRestrictionListArgs:
    def __init__(__self__, *,
                 ...
                 start_min: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.str] end_day: Ending day of restriction (eg. `wednesday`)
        :param pulumi.Input[_builtins.int] end_hour: Ending hour of restriction on defined `end_day`
        :param pulumi.Input[_builtins.int] end_min: Ending minute of restriction on defined `end_hour`
        :param pulumi.Input[_builtins.str] start_day: Starting day of restriction (eg. `monday`)
        :param pulumi.Input[_builtins.int] start_hour: Starting hour of restriction on defined `start_day`
        :param pulumi.Input[_builtins.int] start_min: Staring minute of restriction on defined `start_hour`
        """
    ...
    def end_day(self) -> pulumi.Input[_builtins.str]:
        """
        Ending day of restriction (eg. `wednesday`)
        """
    ...
    @end_day.setter
    def end_day(self, value: pulumi.Input[_builtins.str]):
...
class EscalationRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] condition: The condition for notifying the recipient of escalation rule that is based on the alert state. Possible values are: `if-not-acked` and `if-not-closed`. Default: `if-not-acked`
        :param pulumi.Input[_builtins.int] delay: Time delay of the escalation rule, in minutes.
        :param pulumi.Input[_builtins.str] notify_type: Recipient calculation logic for schedules. Possible values are:
...
class IncidentTemplateStakeholderPropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable: Option to enable stakeholder notifications.Default value is true.
        """
...
class IntegrationActionAcknowledgeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['IntegrationActionAcknowledgeFilterArgs']]] filters: Used to specify rules for matching alerts and the filter type. Please note that depending on the integration type the field names in the filter conditions are:
               ...
               * For API integration: `message`, `alias`, `description`, `source`, `entity`, `tags`, `actions`, `details`, `extra-properties`, `recipients`, `teams`, `priority`, `eventType`.
               * For Email integration: `from_address`, `from_name`, `conversationSubject`, `subject`
        :param pulumi.Input[_builtins.str] note: Additional alert action note.
        ...
        :param pulumi.Input[_builtins.str] user: Owner of the execution for integration action.
        """
        pulumi.set(__self__, "name", name)
...
class IntegrationActionCreateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Name of the integration action.
        :param pulumi.Input[_builtins.str] alias: An identifier that is used for alert deduplication. Default: `{{alias}}`.
        :param pulumi.Input[_builtins.str] custom_priority: Custom alert priority. e.g. ``{{message.substring(0,2)}}``
        :param pulumi.Input[_builtins.str] description: Detailed description of the alert, anything that may not have fit in the `message` field.
        :param pulumi.Input[_builtins.str] entity: The entity the alert is related to.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] extra_properties: Set of user defined properties specified as a map.
        :param pulumi.Input[Sequence[pulumi.Input['IntegrationActionCreateFilterArgs']]] filters: Used to specify rules for matching alerts and the filter type. Please note that depending on the integration type the field names in the filter conditions are:
               ...
               * For API integration: `message`, `alias`, `description`, `source`, `entity`, `tags`, `actions`, `details`, `extra-properties`, `recipients`, `teams`, `priority`, `eventType`.
               * For Email integration: `from_address`, `from_name`, `conversationSubject`, `subject`
        :param pulumi.Input[_builtins.bool] ignore_responders_from_payload: If enabled, the integration will ignore responders sent in request payloads.
        :param pulumi.Input[_builtins.bool] ignore_teams_from_payload: If enabled, the integration will ignore teams sent in request payloads.
        :param pulumi.Input[_builtins.str] message: Alert text limited to 130 characters.
        :param pulumi.Input[_builtins.str] note: Additional alert action note.
        :param pulumi.Input[_builtins.int] order: Integer value that defines in which order the action will be performed. Default: `1`.
        :param pulumi.Input[_builtins.str] priority: Alert priority.
        ...
        :param pulumi.Input[_builtins.str] source: User defined field to specify source of action.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: Comma separated list of labels to be attached to the alert.
        :param pulumi.Input[_builtins.str] type: The responder type - can be `escalation`, `team` or `user`.
        :param pulumi.Input[_builtins.str] user: Owner of the execution for integration action.
        """
        pulumi.set(__self__, "name", name)
...
class NotificationPolicyAutoCloseActionDurationArgs:
    ...
    def time_amount(self) -> pulumi.Input[_builtins.int]:
        """
        A amount of time in `time_units`. This is a integer attribute.
        """
    ...
    @time_amount.setter
    def time_amount(self, value: pulumi.Input[_builtins.int]):
...
if not MYPY:
    class NotificationPolicyAutoRestartActionArgsDict(TypedDict):
        ...
        Duration of this action. This is a block, structure is documented below.
        """
        max_repeat_count: pulumi.Input[_builtins.int]
        """
...
class NotificationPolicyAutoRestartActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_repeat_count: How many times to repeat. This is a integer attribute.
        """
        pulumi.set(__self__, "durations", durations)
    ...
    def max_repeat_count(self) -> pulumi.Input[_builtins.int]:
        """
        How many times to repeat. This is a integer attribute.
        """
    ...
    def max_repeat_count(self, value: pulumi.Input[_builtins.int]):
...
class NotificationPolicyDeDuplicationActionArgs:
    ...
    def de_duplication_action_type(self) -> pulumi.Input[_builtins.str]:
        """
        Deduplication type. Possible values are: "value-based", "frequency-based"
        """
    ...
    def de_duplication_action_type(self, value: pulumi.Input[_builtins.str]):
...
class NotificationPolicyDelayActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] until_hour: Until what hour notifications will be delayed. If `delay_option` is set to antyhing else then `for-duration` this has to be set.
        :param pulumi.Input[_builtins.int] until_minute: Until what minute on `until_hour` notifications will be delayed. If `delay_option` is set to antyhing else then `for-duration` this has to be set.
        """
    ...
    def delay_option(self) -> pulumi.Input[_builtins.str]:
        """
        Defines until what day to delay or for what duration. Possible values are: `for-duration`, `next-time`, `next-weekday`, `next-monday`, `next-tuesday`, `next-wednesday`, `next-thursday`, `next-friday`, `next-saturday`, `next-sunday`
        """
    ...
    @delay_option.setter
    def delay_option(self, value: pulumi.Input[_builtins.str]):
...
class NotificationRuleRepeatArgs:
    ...
    def loop_after(self) -> pulumi.Input[_builtins.int]:
        return pulumi.get(self, "loop_after")

    @loop_after.setter
    def loop_after(self, value: pulumi.Input[_builtins.int]):
...
class NotificationRuleStepArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] send_after: Time period, in minutes, notification will be sent after.
        """
...
class NotificationRuleStepContactArgs:
    def __init__(__self__, *,
                 ...
                 to: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] method: Contact method. Possible values: `email`, `sms`, `voice`, `mobile`
        :param pulumi.Input[_builtins.str] to: Address of a given method (eg. email address for `email`, phone number for `sms`/`voice` or mobile application name for `mobile`)
        """
...
class ScheduleRotationTimeRestrictionRestrictionArgs:
    def __init__(__self__, *,
                 ...
                 start_min: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.int] end_hour: Value of the hour that frame will end.
        :param pulumi.Input[_builtins.int] end_min: Value of the minute that frame will end. Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically.
        :param pulumi.Input[_builtins.int] start_hour: Value of the hour that frame will start.
        :param pulumi.Input[_builtins.int] start_min: Value of the minute that frame will start. Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically.
        """
        pulumi.set(__self__, "end_hour", end_hour)
        pulumi.set(__self__, "end_min", end_min)
        pulumi.set(__self__, "start_hour", start_hour)
...
class ScheduleRotationTimeRestrictionRestrictionListArgs:
    def __init__(__self__, *,
                 ...
                 start_min: pulumi.Input[_builtins.int]):
        """
        :param pulumi.Input[_builtins.str] end_day: Value of the day that frame will end.
        :param pulumi.Input[_builtins.int] end_hour: Value of the hour that frame will end.
        :param pulumi.Input[_builtins.int] end_min: Value of the minute that frame will end. Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically.
               
               Both `start_day` and `end_day` can assume only `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`, or `sunday` values.
        :param pulumi.Input[_builtins.str] start_day: Value of the day that frame will start.
        :param pulumi.Input[_builtins.int] start_hour: Value of the hour that frame will start
        :param pulumi.Input[_builtins.int] start_min: Value of the minute that frame will start. Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically.
        """
        pulumi.set(__self__, "end_day", end_day)
...
class ServiceIncidentRuleIncidentRuleIncidentPropertyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: Description field of the incident rule.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] details: Map of key-value pairs to use as custom properties of the alert.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] tags: Tags of the alert.
        """
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "priority", priority)
...
class TeamRoutingRuleCriteriaConditionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] operation: It is the operation that will be executed for the given field and key. Possible operations are `matches`, `contains`, `starts-with`, `ends-with`, `equals`, `contains-key`, `contains-value`, `greater-than`, `less-than`, `is-empty` and `equals-ignore-whitespace`.
               ...
               * `expectedValue` - (Optional) User defined value that will be compared with alert field according to the operation. Default: empty string.
        :param pulumi.Input[_builtins.str] key: If field is set as extra-properties, key could be used for key-value pair.
        :param pulumi.Input[_builtins.bool] not_: Indicates behaviour of the given operation. Default value is false.
        :param pulumi.Input[_builtins.int] order: Order of the condition in conditions list.
        """
        pulumi.set(__self__, "field", field)
        pulumi.set(__self__, "operation", operation)
...
if not MYPY:
    class UserUserAddressArgsDict(TypedDict):
        ...
        line: pulumi.Input[_builtins.str]
        state: pulumi.Input[_builtins.str]
        zipcode: pulumi.Input[_builtins.str]
elif False:
...
class UserUserAddressArgs:
    ...
    @_builtins.property
    @pulumi.getter
    def line(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "line")

    @line.setter
    def line(self, value: pulumi.Input[_builtins.str]):
    ...
    @_builtins.property
    @pulumi.getter
    def zipcode(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "zipcode")

    @zipcode.setter
    def zipcode(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "zipcode", value)


if not MYPY:
    class GetEscalationRepeatArgsDict(TypedDict):
        close_alert_after_all: NotRequired[_builtins.bool]
        count: NotRequired[_builtins.int]
        reset_recipient_states: NotRequired[_builtins.bool]
        wait_interval: NotRequired[_builtins.int]
elif False:
...
class GetEscalationRepeatArgs:
    ...
    @close_alert_after_all.setter
    def close_alert_after_all(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "close_alert_after_all", value)
    ...
    @count.setter
    def count(self, value: Optional[_builtins.int]):
        pulumi.set(self, "count", value)
    ...
    @reset_recipient_states.setter
    def reset_recipient_states(self, value: Optional[_builtins.bool]):
        pulumi.set(self, "reset_recipient_states", value)
    ...
    @wait_interval.setter
    def wait_interval(self, value: Optional[_builtins.int]):
        pulumi.set(self, "wait_interval", value)
...
class GetEscalationRuleArgs:
    ...
    @condition.setter
    def condition(self, value: _builtins.str):
        pulumi.set(self, "condition", value)
    ...
    @notify_type.setter
    def notify_type(self, value: _builtins.str):
        pulumi.set(self, "notify_type", value)
