...
def get_escalation(description: Optional[builtins.str] = None,
    ...
    :param builtins.str description: Escalation Description
    :param builtins.str name: Name of the escalation.
    :param builtins.str owner_team_id: If owner team exist the id of the team is exported
...
def get_escalation_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
