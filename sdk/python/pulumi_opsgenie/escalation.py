...
class EscalationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Description of the escalation.
        :param pulumi.Input[builtins.str] name: Name of the escalation.
        :param pulumi.Input[builtins.str] owner_team_id: Owner team id of the escalation.
