...
class UserArgs:
    def __init__(__self__, *,
                 ...
                 skype_username: Optional[pulumi.Input[builtins.str]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 timezone: Optional[pulumi.Input[builtins.str]] = None,
                 user_addresses: Optional[pulumi.Input[Sequence[pulumi.Input['UserUserAddressArgs']]]] = None,
                 user_details: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a User resource.
        :param pulumi.Input[builtins.str] full_name: The Full Name of the User.
        :param pulumi.Input[builtins.str] role: The Role assigned to the User. Either a built-in such as 'Admin' or 'User' - or the name of a custom role.
        :param pulumi.Input[builtins.str] username: The email address associated with this user. Opsgenie defines that this must not be longer than 100 characters and must contain lowercase characters only.
        :param pulumi.Input[builtins.str] locale: Location information for the user. Please look at [Supported Locale Ids](https://docs.opsgenie.com/docs/supported-locales) for available locales.
        :param pulumi.Input[builtins.str] skype_username: Skype username of the user.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: A list of tags to be associated with the user.
        :param pulumi.Input[builtins.str] timezone: Timezone information of the user. Please look at [Supported Timezone Ids](https://docs.opsgenie.com/docs/supported-timezone-ids) for available timezones.
        :param pulumi.Input[Sequence[pulumi.Input['UserUserAddressArgs']]] user_addresses: Address of the user.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] user_details: Details about the user in form of key and list. of values.
        """
    ...
    def skype_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def skype_username(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def user_details(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    @user_details.setter
    def user_details(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class User(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="skypeUsername")
    def skype_username(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Skype username of the user.
        """
        return pulumi.get(self, "skype_username")
    ...
    @property
    @pulumi.getter(name="userDetails")
    def user_details(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Details about the user in form of key and list. of values.
        """
        return pulumi.get(self, "user_details")
