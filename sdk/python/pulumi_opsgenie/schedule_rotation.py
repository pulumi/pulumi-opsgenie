...
class ScheduleRotationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] schedule_id: Identifier of the schedule.
        :param pulumi.Input[builtins.str] start_date: This parameter takes a date format as (yyyy-MM-dd'T'HH:mm:ssZ) (e.g. 2019-06-11T08:00:00+02:00). Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically
        :param pulumi.Input[builtins.str] type: Type of rotation. May be one of daily, weekly and hourly.
        :param pulumi.Input[builtins.str] end_date: This parameter takes a date format as (yyyy-MM-dd'T'HH:mm:ssZ) (e.g. 2019-06-11T08:00:00+02:00). Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically
        :param pulumi.Input[builtins.int] length: Length of the rotation with default value 1.
        :param pulumi.Input[builtins.str] name: Name of rotation.
        """
...
class ScheduleRotation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            start_date: Optional[pulumi.Input[builtins.str]] = None,
            time_restrictions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ScheduleRotationTimeRestrictionArgs', 'ScheduleRotationTimeRestrictionArgsDict']]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ScheduleRotation':
        """
    ...
    @property
    @pulumi.getter
    def length(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        Length of the rotation with default value 1.
        """
        return pulumi.get(self, "length")
