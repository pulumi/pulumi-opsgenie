...
def get_team(description: Optional[builtins.str] = None,
    ...
    :param builtins.str description: A description for this team.
    :param Sequence[Union['GetTeamMemberArgs', 'GetTeamMemberArgsDict']] members: A Member block as documented below.
    :param builtins.str name: The name associated with this team. Opsgenie defines that this must not be longer than 100 characters.
...
def get_team_output(description: Optional[pulumi.Input[Optional[builtins.str]]] = None,
