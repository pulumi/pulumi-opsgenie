...
class NotificationPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] team_id: Id of team that this policy belons to.
        ...
        :param pulumi.Input[builtins.bool] suppress: Suppress value of the policy. Values are: `true`, `false`. Default: `false`
...
class NotificationPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter
    def suppress(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Suppress value of the policy. Values are: `true`, `false`. Default: `false`
        """
        return pulumi.get(self, "suppress")
