...
class IncidentTemplateArgs:
    def __init__(__self__, *,
                 ...
                 impacted_services: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] priority: Priority level of the incident. Possible values are `P1`, `P2`, `P3`, `P4` and `P5`.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] details: Map of key-value pairs to use as custom properties of the incident template. This field must not be longer than 8000 characters.
        :param pulumi.Input[builtins.str] name: Name of the incident template.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags of the incident template.
        """
    ...
    def impacted_services(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "impacted_services")

    @impacted_services.setter
    def impacted_services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class IncidentTemplate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority: Optional[pulumi.Input[builtins.str]] = None,
            stakeholder_properties: Optional[pulumi.Input[Sequence[pulumi.Input[Union['IncidentTemplateStakeholderPropertyArgs', 'IncidentTemplateStakeholderPropertyArgsDict']]]]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'IncidentTemplate':
        """
    ...
    @property
    @pulumi.getter
    def details(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Map of key-value pairs to use as custom properties of the incident template. This field must not be longer than 8000 characters.
        """
        return pulumi.get(self, "details")
    ...
    @property
    @pulumi.getter(name="impactedServices")
    def impacted_services(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "impacted_services")
