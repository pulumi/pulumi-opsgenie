...
class UserContactArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] method: This parameter is the contact method of user and should be one of email, sms or voice. Please note that adding mobile is not supported from API.
        :param pulumi.Input[builtins.str] to: to field is the address of given method.
        :param pulumi.Input[builtins.str] username: The username for contact.(reference)
        :param pulumi.Input[builtins.bool] enabled: Enable contact of the user in OpsGenie. Default value is true.
        """
...
class UserContact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            method: Optional[pulumi.Input[builtins.str]] = None,
            to: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'UserContact':
        """
    ...
    @property
    @pulumi.getter
    def to(self) -> pulumi.Output[builtins.str]:
        """
        to field is the address of given method.
        """
        return pulumi.get(self, "to")
