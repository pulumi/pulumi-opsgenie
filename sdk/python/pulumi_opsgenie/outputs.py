...
class AlertPolicyFilter(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: A filter type, supported types are: `match-all`, `match-any-condition`, `match-all-conditions`. Default: `match-all`
        """
...
class AlertPolicyFilterCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str field: Specifies which alert field will be used in condition. Possible values are `message`, `alias`, `description`, `source`, `entity`, `tags`, `actions`, `details`, `extra-properties`, `responders`, `teams`, `priority`
        :param builtins.str operation: It is the operation that will be executed for the given field and key. Possible operations are `matches`, `contains`, `starts-with`, `ends-with`, `equals`, `contains-key`, `contains-value`, `greater-than`, `less-than`, `is-empty`, `equals-ignore-whitespace`.
        :param builtins.str expected_value: User defined value that will be compared with alert field according to the operation. Default: empty string
        :param builtins.str key: If `field` is set as extra-properties, key could be used for key-value pair
        :param builtins.bool not_: Indicates behaviour of the given operation. Default: `false`
        :param builtins.int order: Order of the condition in conditions list
        """
...
class AlertPolicyResponder(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: ID of the responder
        :param builtins.str type: Type of responder. Acceptable values are: `user`, `team`, `escalation` or `schedule`
...
class AlertPolicyTimeRestriction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Defines if restriction should apply daily on given hours or on certain days and hours. Possible values are: `time-of-day`, `weekday-and-time-of-day`
...
class AlertPolicyTimeRestrictionRestriction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int end_hour: Ending hour of restriction.
        :param builtins.int end_min: Ending minute of restriction on defined `end_hour`
        :param builtins.int start_hour: Starting hour of restriction.
        :param builtins.int start_min: Staring minute of restriction on defined `start_hour`
        """
    ...
    def end_hour(self) -> builtins.int:
        """
    ...
    def start_min(self) -> builtins.int:
        """
...
class AlertPolicyTimeRestrictionRestrictionList(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_min: builtins.int):
        """
        :param builtins.str end_day: Ending day of restriction (eg. `wednesday`)
        :param builtins.int end_hour: Ending hour of restriction on defined `end_day`
        :param builtins.int end_min: Ending minute of restriction on defined `end_hour`
        :param builtins.str start_day: Starting day of restriction (eg. `monday`)
        :param builtins.int start_hour: Starting hour of restriction on defined `start_day`
        :param builtins.int start_min: Staring minute of restriction on defined `start_hour`
        """
...
class ApiIntegrationResponder(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str id: The id of the responder.
        :param builtins.str type: The responder type.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if type is not None:
...
class EmailIntegrationResponder(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str id: The ID of the Opsgenie Email based Integration.
        :param builtins.str type: The responder type.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
...
class EscalationRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str condition: The condition for notifying the recipient of escalation rule that is based on the alert state. Possible values are: `if-not-acked` and `if-not-closed`. Default: `if-not-acked`
        :param builtins.int delay: Time delay of the escalation rule, in minutes.
        :param builtins.str notify_type: Recipient calculation logic for schedules. Possible values are:
...
class IncidentTemplateStakeholderProperty(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str message: Message of the related incident template. This field must not be longer than 130 characters.
        :param builtins.str description: Description field of the incident template. This field must not be longer than 10000 characters.
        :param builtins.bool enable: Option to enable stakeholder notifications.Default value is true.
        """
...
class IntegrationActionAcknowledge(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Name of the integration action.
        :param builtins.str alias: An identifier that is used for alert deduplication. Default: `{{alias}}`.
        ...
        :param builtins.str note: Additional alert action note.
        :param builtins.int order: Integer value that defines in which order the action will be performed. Default: `1`.
        :param builtins.str type: The responder type - can be `escalation`, `team` or `user`.
        :param builtins.str user: Owner of the execution for integration action.
        """
        pulumi.set(__self__, "name", name)
...
class IntegrationActionCreate(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 alert_actions: Optional[Sequence[builtins.str]] = None,
                 alias: Optional[builtins.str] = None,
                 append_attachments: Optional[builtins.bool] = None,
                 custom_priority: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 entity: Optional[builtins.str] = None,
                 extra_properties: Optional[Mapping[str, builtins.str]] = None,
                 filters: Optional[Sequence['outputs.IntegrationActionCreateFilter']] = None,
                 ignore_alert_actions_from_payload: Optional[builtins.bool] = None,
                 ignore_extra_properties_from_payload: Optional[builtins.bool] = None,
                 ignore_responders_from_payload: Optional[builtins.bool] = None,
                 ignore_tags_from_payload: Optional[builtins.bool] = None,
                 ignore_teams_from_payload: Optional[builtins.bool] = None,
        ...
        :param builtins.str name: Name of the integration action.
        :param builtins.str alias: An identifier that is used for alert deduplication. Default: `{{alias}}`.
        :param builtins.str custom_priority: Custom alert priority. e.g. ``{{message.substring(0,2)}}``
        :param builtins.str description: Detailed description of the alert, anything that may not have fit in the `message` field.
        :param builtins.str entity: The entity the alert is related to.
        :param Mapping[str, builtins.str] extra_properties: Set of user defined properties specified as a map.
        :param Sequence['IntegrationActionCreateFilterArgs'] filters: Used to specify rules for matching alerts and the filter type. Please note that depending on the integration type the field names in the filter conditions are:
               ...
               * For API integration: `message`, `alias`, `description`, `source`, `entity`, `tags`, `actions`, `details`, `extra-properties`, `recipients`, `teams`, `priority`, `eventType`.
               * For Email integration: `from_address`, `from_name`, `conversationSubject`, `subject`
        :param builtins.bool ignore_responders_from_payload: If enabled, the integration will ignore responders sent in request payloads.
        :param builtins.bool ignore_teams_from_payload: If enabled, the integration will ignore teams sent in request payloads.
        :param builtins.str message: Alert text limited to 130 characters.
        :param builtins.str note: Additional alert action note.
        :param builtins.int order: Integer value that defines in which order the action will be performed. Default: `1`.
        :param builtins.str priority: Alert priority.
        ...
        :param builtins.str source: User defined field to specify source of action.
        :param Sequence[builtins.str] tags: Comma separated list of labels to be attached to the alert.
        :param builtins.str type: The responder type - can be `escalation`, `team` or `user`.
        :param builtins.str user: Owner of the execution for integration action.
        """
        pulumi.set(__self__, "name", name)
    ...
    def alert_actions(self) -> Optional[Sequence[builtins.str]]:
    ...
    def append_attachments(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "append_attachments")

    @property
    @pulumi.getter(name="customPriority")
    def custom_priority(self) -> Optional[builtins.str]:
        """
    ...
    def extra_properties(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def ignore_tags_from_payload(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "ignore_tags_from_payload")

    @property
    @pulumi.getter(name="ignoreTeamsFromPayload")
    def ignore_teams_from_payload(self) -> Optional[builtins.bool]:
        """
...
class MaintenanceRule(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str state: State of rule that will be defined in maintenance and can take either enabled or disabled for policy type rules. This field has to be disabled for integration type entity rules.
        """
...
class MaintenanceRuleEntity(dict):
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str id: The id of the entity that maintenance will be applied.
        :param builtins.str type: The type of the entity that maintenance will be applied. It can be either integration or policy.
        """
        if id is not None:
            pulumi.set(__self__, "id", id)
        if type is not None:
...
class MaintenanceTime(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str end_date: This parameter takes a date format as (yyyy-MM-dd'T'HH:mm:ssZ) (e.g. 2019-06-11T08:00:00+02:00).
        :param builtins.str start_date: This parameter takes a date format as (yyyy-MM-dd'T'HH:mm:ssZ) (e.g. 2019-06-11T08:00:00+02:00).
        """
        pulumi.set(__self__, "type", type)
...
class NotificationPolicyAutoCloseActionDuration(dict):
    ...
    def __init__(__self__, *,
                 time_amount: builtins.int,
                 time_unit: Optional[builtins.str] = None):
        """
        :param builtins.int time_amount: A amount of time in `time_units`. This is a integer attribute.
        :param builtins.str time_unit: Valid time units are: `minutes`, `hours`, `days`. Default: `minutes`
        """
    ...
    def time_amount(self) -> builtins.int:
        """
...
class NotificationPolicyAutoRestartAction(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.int max_repeat_count: How many times to repeat. This is a integer attribute.
        """
        pulumi.set(__self__, "durations", durations)
    ...
    def max_repeat_count(self) -> builtins.int:
        """
...
class NotificationPolicyDeDuplicationAction(dict):
    ...
    def __init__(__self__, *,
                 count: builtins.int,
                 de_duplication_action_type: builtins.str,
                 durations: Optional[Sequence['outputs.NotificationPolicyDeDuplicationActionDuration']] = None):
        """
        :param builtins.int count: Count
        :param builtins.str de_duplication_action_type: Deduplication type. Possible values are: "value-based", "frequency-based"
    ...
    def de_duplication_action_type(self) -> builtins.str:
        """
...
class NotificationPolicyDelayAction(dict):
    ...
    def __init__(__self__, *,
                 delay_option: builtins.str,
                 durations: Optional[Sequence['outputs.NotificationPolicyDelayActionDuration']] = None,
                 until_hour: Optional[builtins.int] = None,
                 until_minute: Optional[builtins.int] = None):
        """
        :param builtins.str delay_option: Defines until what day to delay or for what duration. Possible values are: `for-duration`, `next-time`, `next-weekday`, `next-monday`, `next-tuesday`, `next-wednesday`, `next-thursday`, `next-friday`, `next-saturday`, `next-sunday`
        ...
        :param builtins.int until_hour: Until what hour notifications will be delayed. If `delay_option` is set to antyhing else then `for-duration` this has to be set.
        :param builtins.int until_minute: Until what minute on `until_hour` notifications will be delayed. If `delay_option` is set to antyhing else then `for-duration` this has to be set.
        """
    ...
    def delay_option(self) -> builtins.str:
        """
    ...
    def until_hour(self) -> Optional[builtins.int]:
        """
    ...
    def until_minute(self) -> Optional[builtins.int]:
        """
...
class NotificationRuleCriteria(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Kind of matching filter. Possible values: `match-all`, `match-any-condition`, `match-all-conditions`
...
class NotificationRuleCriteriaCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 order: Optional[builtins.int] = None):
        """
        :param builtins.str field: Possible values: `message`, `alias`, `description`, `source`, `entity`, `tags`, `actions`, `details`, `extra-properties`, `recipients`, `teams`, `priority`
        :param builtins.str operation: Possible values: `matches`, `contains`, `starts-with`, `ends-with`, `equals`, `contains-key`, `contains-value`, `greater-than`, `less-than`, `is-empty`, `equals-ignore-whitespace`
        :param builtins.str expected_value: User defined value that will be compared with alert field according to the operation. Default: empty string
        :param builtins.str key: If 'field' is set as 'extra-properties', key could be used for key-value pair
        :param builtins.bool not_: Indicates behaviour of the given operation. Default: `false`
        :param builtins.int order: Order of the condition in conditions list
...
class NotificationRuleRepeat(dict):
    ...
    def __init__(__self__, *,
                 loop_after: builtins.int,
                 enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool enabled: If policy should be enabled. Default: `true`
        """
    ...
    def loop_after(self) -> builtins.int:
...
class NotificationRuleSchedule(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str name: Name of the notification policy
        :param builtins.str type: Kind of matching filter. Possible values: `match-all`, `match-any-condition`, `match-all-conditions`
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "type", type)
...
class NotificationRuleStep(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enabled: Optional[builtins.bool] = None,
                 send_after: Optional[builtins.int] = None):
        """
        ...
        :param builtins.bool enabled: Defined if this step is enabled. Default: `true`
        :param builtins.int send_after: Time period, in minutes, notification will be sent after.
        """
    ...
    def send_after(self) -> Optional[builtins.int]:
        """
...
class NotificationRuleStepContact(dict):
    def __init__(__self__, *,
                 ...
                 to: builtins.str):
        """
        :param builtins.str method: Contact method. Possible values: `email`, `sms`, `voice`, `mobile`
        :param builtins.str to: Address of a given method (eg. email address for `email`, phone number for `sms`/`voice` or mobile application name for `mobile`)
        """
...
class ScheduleRotationTimeRestriction(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: This parameter should be set to `time-of-day` or `weekday-and-time-of-day`.
...
class ScheduleRotationTimeRestrictionRestriction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_min: builtins.int):
        """
        :param builtins.int end_hour: Value of the hour that frame will end.
        :param builtins.int end_min: Value of the minute that frame will end. Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically.
        :param builtins.int start_hour: Value of the hour that frame will start.
        :param builtins.int start_min: Value of the minute that frame will start. Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically.
        """
        pulumi.set(__self__, "end_hour", end_hour)
        pulumi.set(__self__, "end_min", end_min)
        pulumi.set(__self__, "start_hour", start_hour)
...
class ScheduleRotationTimeRestrictionRestrictionList(dict):
    ...
    def __init__(__self__, *,
                 ...
                 start_min: builtins.int):
        """
        :param builtins.str end_day: Value of the day that frame will end.
        :param builtins.int end_hour: Value of the hour that frame will end.
        :param builtins.int end_min: Value of the minute that frame will end. Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically.
               
               Both `start_day` and `end_day` can assume only `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`, or `sunday` values.
        :param builtins.str start_day: Value of the day that frame will start.
        :param builtins.int start_hour: Value of the hour that frame will start
        :param builtins.int start_min: Value of the minute that frame will start. Minutes may take 0 or 30 as value. Otherwise they will be converted to nearest 0 or 30 automatically.
        """
        pulumi.set(__self__, "end_day", end_day)
...
class ServiceIncidentRuleIncidentRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 condition_match_type: Optional[builtins.str] = None,
        ...
        :param builtins.str condition_match_type: A Condition type, supported types are: `match-all`, `match-any-condition`, `match-all-conditions`. Default: `match-all`
    ...
    def condition_match_type(self) -> Optional[builtins.str]:
        """
...
class ServiceIncidentRuleIncidentRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 not_: Optional[builtins.bool] = None):
        """
        :param builtins.str field: Specifies which alert field will be used in condition. Possible values are `message`, `alias`, `description`, `source`, `entity`, `tags`, `actions`, `details`, `extra-properties`, `recipients`, `teams`, `priority`
        :param builtins.str operation: It is the operation that will be executed for the given field and key. Possible operations are `matches`, `contains`, `starts-with`, `ends-with`, `equals`, `contains-key`, `contains-value`, `greater-than`, `less-than`, `is-empty`, `equals-ignore-whitespace`.
        :param builtins.str expected_value: User defined value that will be compared with alert field according to the operation. Default: empty string
        :param builtins.str key: If 'field' is set as 'extra-properties', key could be used for key-value pair
        :param builtins.bool not_: Indicates behaviour of the given operation. Default: false
...
class ServiceIncidentRuleIncidentRuleIncidentProperty(dict):
    ...
    def __init__(__self__, *,
                 ...
                 tags: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str message: Message of the related incident rule.
        :param builtins.str priority: Priority level of the alert. Possible values are `P1`, `P2`, `P3`, `P4` and `P5`
        ...
        :param builtins.str description: Description field of the incident rule.
        :param Mapping[str, builtins.str] details: Map of key-value pairs to use as custom properties of the alert.
        :param Sequence[builtins.str] tags: Tags of the alert.
        """
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "priority", priority)
...
class ServiceIncidentRuleIncidentRuleIncidentPropertyStakeholderProperty(dict):
    def __init__(__self__, *,
                 ...
                 enable: Optional[builtins.bool] = None):
        """
        :param builtins.str message: Message that is to be passed to audience that is generally used to provide a content information about the alert.
        :param builtins.str description: Description that is generally used to provide a detailed information about the alert.
        :param builtins.bool enable: Option to enable stakeholder notifications.Default value is true.
        """
        pulumi.set(__self__, "message", message)
        if description is not None:
...
class TeamMember(dict):
    def __init__(__self__, *,
                 ...
                 username: Optional[builtins.str] = None):
        """
        :param builtins.str id: The UUID for the member to add to this Team.
        :param builtins.str role: The role for the user within the Team - can be either `admin` or `user`. Default: `user`.
        """
        pulumi.set(__self__, "id", id)
        if role is not None:
...
class TeamRoutingRuleCriteria(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: Type of the operation will be applied on conditions. Should be one of `match-all`, `match-any-condition` or `match-all-conditions`.
...
class TeamRoutingRuleCriteriaCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 order: Optional[builtins.int] = None):
        """
        :param builtins.str field: Specifies which alert field will be used in condition. Possible values are `message`, `alias`, `description`, `source`, `entity`, `tags`, `actions`, `extra-properties`, `recipients`, `teams` or `priority`.
        :param builtins.str operation: It is the operation that will be executed for the given field and key. Possible operations are `matches`, `contains`, `starts-with`, `ends-with`, `equals`, `contains-key`, `contains-value`, `greater-than`, `less-than`, `is-empty` and `equals-ignore-whitespace`.
        ...
        :param builtins.str key: If field is set as extra-properties, key could be used for key-value pair.
        :param builtins.bool not_: Indicates behaviour of the given operation. Default value is false.
        :param builtins.int order: Order of the condition in conditions list.
        """
        pulumi.set(__self__, "field", field)
        pulumi.set(__self__, "operation", operation)
