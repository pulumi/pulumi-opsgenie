...
class ProviderArgs:
    ...
    def api_retry_count(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "api_retry_count")

    @api_retry_count.setter
    def api_retry_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "api_retry_count", value)

    @property
    @pulumi.getter(name="apiRetryWaitMax")
    def api_retry_wait_max(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "api_retry_wait_max")

    @api_retry_wait_max.setter
    def api_retry_wait_max(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "api_retry_wait_max", value)

    @property
    @pulumi.getter(name="apiRetryWaitMin")
    def api_retry_wait_min(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "api_retry_wait_min")

    @api_retry_wait_min.setter
    def api_retry_wait_min(self, value: Optional[pulumi.Input[builtins.int]]):
