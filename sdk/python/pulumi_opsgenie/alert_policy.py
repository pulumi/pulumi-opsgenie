...
class AlertPolicyArgs:
    def __init__(__self__, *,
                 ...
                 continue_policy: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 ignore_original_actions: Optional[pulumi.Input[builtins.bool]] = None,
                 ignore_original_details: Optional[pulumi.Input[builtins.bool]] = None,
                 ignore_original_responders: Optional[pulumi.Input[builtins.bool]] = None,
                 ignore_original_tags: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] message: Message of the alerts
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] actions: Actions to add to the alerts original actions value as a list of strings. If `ignore_original_actions` field is set to `true`, this will replace the original actions.
        :param pulumi.Input[builtins.str] alert_description: Description of the alert. You can use `{{description}}` to refer to the original alert description. Default: `{{description}}`
        :param pulumi.Input[builtins.str] alias: Alias of the alert. You can use `{{alias}}` to refer to the original alias. Default: `{{alias}}`
        :param pulumi.Input[builtins.bool] continue_policy: It will trigger other modify policies if set to `true`. Default: `false`
        :param pulumi.Input[builtins.bool] enabled: If policy should be enabled. Default: `true`
        :param pulumi.Input[builtins.str] entity: Entity field of the alert. You can use `{{entity}}` to refer to the original entity. Default: `{{entity}}`
        ...
        :param pulumi.Input[builtins.bool] ignore_original_actions: If set to `true`, policy will ignore the original actions of the alert. Default: `false`
        :param pulumi.Input[builtins.bool] ignore_original_details: If set to `true`, policy will ignore the original details of the alert. Default: `false`
        :param pulumi.Input[builtins.bool] ignore_original_responders: If set to `true`, policy will ignore the original responders of the alert. Default: `false`
        :param pulumi.Input[builtins.bool] ignore_original_tags: If set to `true`, policy will ignore the original tags of the alert. Default: `false`
        :param pulumi.Input[builtins.str] name: Name of the alert policy
        :param pulumi.Input[builtins.str] policy_description: Description of the policy. This can be max 512 characters.
        :param pulumi.Input[builtins.str] priority: Priority of the alert. Should be one of `P1`, `P2`, `P3`, `P4`, or `P5`
        ...
        :param pulumi.Input[builtins.str] source: Source field of the alert. You can use `{{source}}` to refer to the original source. Default: `{{source}}`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Tags to add to the alerts original tags value as a list of strings. If `ignore_original_responders` field is set to `true`, this will replace the original responders.
        :param pulumi.Input[builtins.str] team_id: Id of team that this policy belongs to.
    ...
    def continue_policy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def continue_policy(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ignore_original_actions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_original_actions(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ignore_original_actions", value)

    @property
    @pulumi.getter(name="ignoreOriginalDetails")
    def ignore_original_details(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_original_details(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ignore_original_details", value)

    @property
    @pulumi.getter(name="ignoreOriginalResponders")
    def ignore_original_responders(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_original_responders(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "ignore_original_responders", value)

    @property
    @pulumi.getter(name="ignoreOriginalTags")
    def ignore_original_tags(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def ignore_original_tags(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AlertPolicy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="continuePolicy")
    def continue_policy(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        It will trigger other modify policies if set to `true`. Default: `false`
        """
        return pulumi.get(self, "continue_policy")
    ...
    @property
    @pulumi.getter
    def entity(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Entity field of the alert. You can use `{{entity}}` to refer to the original entity. Default: `{{entity}}`
        """
        return pulumi.get(self, "entity")
    ...
    @property
    @pulumi.getter(name="ignoreOriginalActions")
    def ignore_original_actions(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to `true`, policy will ignore the original actions of the alert. Default: `false`
        """
        return pulumi.get(self, "ignore_original_actions")
    ...
    @property
    @pulumi.getter(name="ignoreOriginalDetails")
    def ignore_original_details(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to `true`, policy will ignore the original details of the alert. Default: `false`
        """
        return pulumi.get(self, "ignore_original_details")
    ...
    @property
    @pulumi.getter(name="ignoreOriginalResponders")
    def ignore_original_responders(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to `true`, policy will ignore the original responders of the alert. Default: `false`
        """
        return pulumi.get(self, "ignore_original_responders")
    ...
    @property
    @pulumi.getter(name="ignoreOriginalTags")
    def ignore_original_tags(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        If set to `true`, policy will ignore the original tags of the alert. Default: `false`
        """
        return pulumi.get(self, "ignore_original_tags")
