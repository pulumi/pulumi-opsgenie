...
class HeartbeatArgs:
    def __init__(__self__, *,
                 ...
                 interval_unit: pulumi.Input[builtins.str],
                 alert_message: Optional[pulumi.Input[builtins.str]] = None,
                 alert_priority: Optional[pulumi.Input[builtins.str]] = None,
                 alert_tags: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.bool] enabled: Enable/disable heartbeat monitoring.
        :param pulumi.Input[builtins.int] interval: Specifies how often a heartbeat message should be expected.
        :param pulumi.Input[builtins.str] interval_unit: Interval specified as minutes, hours or days.
        :param pulumi.Input[builtins.str] alert_message: Specifies the alert message for heartbeat expiration alert. If this is not provided, default alert message is "HeartbeatName is expired".
        :param pulumi.Input[builtins.str] alert_priority: Specifies the alert priority for heartbeat expiration alert. If this is not provided, default priority is P3.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] alert_tags: Specifies the alert tags for heartbeat expiration alert.
        :param pulumi.Input[builtins.str] description: An optional description of the heartbeat
        :param pulumi.Input[builtins.str] name: Name of the heartbeat
        :param pulumi.Input[builtins.str] owner_team_id: Owner team of the heartbeat.
        """
    ...
    def interval_unit(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def interval_unit(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "interval_unit", value)

    @property
    @pulumi.getter(name="alertMessage")
    def alert_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_message(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_message", value)

    @property
    @pulumi.getter(name="alertPriority")
    def alert_priority(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def alert_priority(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_priority", value)

    @property
    @pulumi.getter(name="alertTags")
    def alert_tags(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @alert_tags.setter
    def alert_tags(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _HeartbeatState:
    def __init__(__self__, *,
                 ...
                 interval_unit: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 owner_team_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="intervalUnit")
    def interval_unit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Interval specified as minutes, hours or days.
        """
        return pulumi.get(self, "interval_unit")
    ...
    @interval_unit.setter
    def interval_unit(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "interval_unit", value)
...
class Heartbeat(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            interval_unit: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            owner_team_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Heartbeat':
        """
    ...
    @property
    @pulumi.getter(name="alertMessage")
    def alert_message(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the alert message for heartbeat expiration alert. If this is not provided, default alert message is "HeartbeatName is expired".
        """
        return pulumi.get(self, "alert_message")
    ...
    @property
    @pulumi.getter(name="alertPriority")
    def alert_priority(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Specifies the alert priority for heartbeat expiration alert. If this is not provided, default priority is P3.
        """
        return pulumi.get(self, "alert_priority")
    ...
    @property
    @pulumi.getter(name="alertTags")
    def alert_tags(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Specifies the alert tags for heartbeat expiration alert.
        """
        return pulumi.get(self, "alert_tags")
    ...
    @property
    @pulumi.getter(name="intervalUnit")
    def interval_unit(self) -> pulumi.Output[builtins.str]:
        """
        Interval specified as minutes, hours or days.
        """
        return pulumi.get(self, "interval_unit")
