...
class CustomRoleArgs:
    def __init__(__self__, *,
                 ...
                 disallowed_rights: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 extended_role: Optional[pulumi.Input[builtins.str]] = None,
                 granted_rights: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disallowed_rights: The rights this role cannot have. For allowed values please refer [User Right Prerequisites](https://docs.opsgenie.com/docs/custom-user-role-api#section-user-right-prerequisites)
        :param pulumi.Input[builtins.str] extended_role: The role from which this role has been derived. Allowed Values: "user", "observer", "stakeholder".
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] granted_rights: The rights granted to this role. For allowed values please refer [User Right Prerequisites](https://docs.opsgenie.com/docs/custom-user-role-api#section-user-right-prerequisites)
        """
    ...
    def disallowed_rights(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def disallowed_rights(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "disallowed_rights", value)

    @property
    @pulumi.getter(name="extendedRole")
    def extended_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def extended_role(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "extended_role", value)

    @property
    @pulumi.getter(name="grantedRights")
    def granted_rights(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def granted_rights(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class CustomRole(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            extended_role: Optional[pulumi.Input[builtins.str]] = None,
            granted_rights: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            role_name: Optional[pulumi.Input[builtins.str]] = None) -> 'CustomRole':
        """
    ...
    @property
    @pulumi.getter(name="disallowedRights")
    def disallowed_rights(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The rights this role cannot have. For allowed values please refer [User Right Prerequisites](https://docs.opsgenie.com/docs/custom-user-role-api#section-user-right-prerequisites)
        """
        return pulumi.get(self, "disallowed_rights")
    ...
    @property
    @pulumi.getter(name="extendedRole")
    def extended_role(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The role from which this role has been derived. Allowed Values: "user", "observer", "stakeholder".
        """
        return pulumi.get(self, "extended_role")
    ...
    @property
    @pulumi.getter(name="grantedRights")
    def granted_rights(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The rights granted to this role. For allowed values please refer [User Right Prerequisites](https://docs.opsgenie.com/docs/custom-user-role-api#section-user-right-prerequisites)
        """
        return pulumi.get(self, "granted_rights")
