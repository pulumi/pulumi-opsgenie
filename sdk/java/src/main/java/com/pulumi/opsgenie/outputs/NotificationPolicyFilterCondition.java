...
public final class NotificationPolicyFilterCondition {
    ...
    public static final class Builder {
        ...
        public Builder field(String field) {
            if (field == null) {
              throw new MissingRequiredPropertyException("NotificationPolicyFilterCondition", "field");
            }
            this.field = field;
            return this;
        }
        ...
        public Builder operation(String operation) {
            if (operation == null) {
              throw new MissingRequiredPropertyException("NotificationPolicyFilterCondition", "operation");
            }
