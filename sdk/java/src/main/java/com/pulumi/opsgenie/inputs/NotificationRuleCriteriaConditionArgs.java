...
public final class NotificationRuleCriteriaConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final NotificationRuleCriteriaConditionArgs Empty = new NotificationRuleCriteriaConditionArgs();
    ...
    private NotificationRuleCriteriaConditionArgs() {}

    private NotificationRuleCriteriaConditionArgs(NotificationRuleCriteriaConditionArgs $) {
    ...
    public static Builder builder(NotificationRuleCriteriaConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NotificationRuleCriteriaConditionArgs();
        }

        public Builder(NotificationRuleCriteriaConditionArgs defaults) {
            $ = new NotificationRuleCriteriaConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param field Possible values: `message`, `alias`, `description`, `source`, `entity`, `tags`, `actions`, `details`, `extra-properties`, `recipients`, `teams`, `priority`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param operation Possible values: `matches`, `contains`, `starts-with`, `ends-with`, `equals`, `contains-key`, `contains-value`, `greater-than`, `less-than`, `is-empty`, `equals-ignore-whitespace`
         * 
         * @return builder
         * 
         */
        ...
        public NotificationRuleCriteriaConditionArgs build() {
            if ($.field == null) {
                throw new MissingRequiredPropertyException("NotificationRuleCriteriaConditionArgs", "field");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("NotificationRuleCriteriaConditionArgs", "operation");
            }
            return $;
        }
    }
