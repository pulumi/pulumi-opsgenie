...
public final class IntegrationActionCloseFilterConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public IntegrationActionCloseFilterConditionArgs build() {
            if ($.field == null) {
                throw new MissingRequiredPropertyException("IntegrationActionCloseFilterConditionArgs", "field");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("IntegrationActionCloseFilterConditionArgs", "operation");
            }
            return $;
        }
    }
