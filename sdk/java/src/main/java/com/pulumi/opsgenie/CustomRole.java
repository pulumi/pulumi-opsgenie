...
public class CustomRole extends com.pulumi.resources.CustomResource {
     ...
     */
    public CustomRole(java.lang.String name) {
     ...
     */
    public CustomRole(java.lang.String name, CustomRoleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CustomRole(java.lang.String name, CustomRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("opsgenie:index/customRole:CustomRole", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CustomRole(java.lang.String name, Output<java.lang.String> id, @Nullable CustomRoleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("opsgenie:index/customRole:CustomRole", name, state, makeResourceOptions(options, id), false);
    }

    private static CustomRoleArgs makeArgs(CustomRoleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CustomRoleArgs.Empty : args;
    }
     ...
     */
    public static CustomRole get(java.lang.String name, Output<java.lang.String> id, @Nullable CustomRoleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
