...
public final class ServiceIncidentRuleIncidentRuleConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ServiceIncidentRuleIncidentRuleConditionArgs Empty = new ServiceIncidentRuleIncidentRuleConditionArgs();
    ...
    private ServiceIncidentRuleIncidentRuleConditionArgs() {}

    private ServiceIncidentRuleIncidentRuleConditionArgs(ServiceIncidentRuleIncidentRuleConditionArgs $) {
    ...
    public static Builder builder(ServiceIncidentRuleIncidentRuleConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ServiceIncidentRuleIncidentRuleConditionArgs();
        }

        public Builder(ServiceIncidentRuleIncidentRuleConditionArgs defaults) {
            $ = new ServiceIncidentRuleIncidentRuleConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ServiceIncidentRuleIncidentRuleConditionArgs build() {
            if ($.field == null) {
                throw new MissingRequiredPropertyException("ServiceIncidentRuleIncidentRuleConditionArgs", "field");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("ServiceIncidentRuleIncidentRuleConditionArgs", "operation");
            }
            return $;
        }
    }
