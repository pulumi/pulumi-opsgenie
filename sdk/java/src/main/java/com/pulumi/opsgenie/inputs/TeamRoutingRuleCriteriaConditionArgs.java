...
public final class TeamRoutingRuleCriteriaConditionArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TeamRoutingRuleCriteriaConditionArgs build() {
            if ($.field == null) {
                throw new MissingRequiredPropertyException("TeamRoutingRuleCriteriaConditionArgs", "field");
            }
            if ($.operation == null) {
                throw new MissingRequiredPropertyException("TeamRoutingRuleCriteriaConditionArgs", "operation");
            }
            return $;
        }
    }
