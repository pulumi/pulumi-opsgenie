...
public final class AlertPolicyTimeRestrictionRestrictionListArgs extends com.pulumi.resources.ResourceArgs {

    public static final AlertPolicyTimeRestrictionRestrictionListArgs Empty = new AlertPolicyTimeRestrictionRestrictionListArgs();
    ...
    private AlertPolicyTimeRestrictionRestrictionListArgs() {}

    private AlertPolicyTimeRestrictionRestrictionListArgs(AlertPolicyTimeRestrictionRestrictionListArgs $) {
        this.endDay = $.endDay;
    ...
    public static Builder builder(AlertPolicyTimeRestrictionRestrictionListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AlertPolicyTimeRestrictionRestrictionListArgs();
        }

        public Builder(AlertPolicyTimeRestrictionRestrictionListArgs defaults) {
            $ = new AlertPolicyTimeRestrictionRestrictionListArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param endDay Ending day of restriction (eg. `wednesday`)
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param startDay Starting day of restriction (eg. `monday`)
         * 
         * @return builder
         * 
         */
        ...
        public AlertPolicyTimeRestrictionRestrictionListArgs build() {
            if ($.endDay == null) {
                throw new MissingRequiredPropertyException("AlertPolicyTimeRestrictionRestrictionListArgs", "endDay");
            }
            if ($.endHour == null) {
                throw new MissingRequiredPropertyException("AlertPolicyTimeRestrictionRestrictionListArgs", "endHour");
            }
            if ($.endMin == null) {
                throw new MissingRequiredPropertyException("AlertPolicyTimeRestrictionRestrictionListArgs", "endMin");
            }
            if ($.startDay == null) {
                throw new MissingRequiredPropertyException("AlertPolicyTimeRestrictionRestrictionListArgs", "startDay");
            }
            if ($.startHour == null) {
                throw new MissingRequiredPropertyException("AlertPolicyTimeRestrictionRestrictionListArgs", "startHour");
            }
            if ($.startMin == null) {
                throw new MissingRequiredPropertyException("AlertPolicyTimeRestrictionRestrictionListArgs", "startMin");
            }
            return $;
        }
    }
