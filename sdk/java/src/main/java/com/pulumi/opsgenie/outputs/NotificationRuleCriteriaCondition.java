...
public final class NotificationRuleCriteriaCondition {
    ...
    public static final class Builder {
        ...
        public Builder field(String field) {
            if (field == null) {
              throw new MissingRequiredPropertyException("NotificationRuleCriteriaCondition", "field");
            }
            this.field = field;
            return this;
        }
        ...
        public Builder operation(String operation) {
            if (operation == null) {
              throw new MissingRequiredPropertyException("NotificationRuleCriteriaCondition", "operation");
            }
        ...
        public NotificationRuleCriteriaCondition build() {
            final var _resultValue = new NotificationRuleCriteriaCondition();
