...
public final class GetHeartbeatArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetHeartbeatArgs Empty = new GetHeartbeatArgs();
    ...
    private GetHeartbeatArgs() {}

    private GetHeartbeatArgs(GetHeartbeatArgs $) {
    ...
    public static Builder builder(GetHeartbeatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHeartbeatArgs();
        }

        public Builder(GetHeartbeatArgs defaults) {
            $ = new GetHeartbeatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetHeartbeatArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetHeartbeatArgs", "name");
            }
            return $;
        }
    }
