...
public final class HeartbeatArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public HeartbeatArgs build() {
            if ($.enabled == null) {
                throw new MissingRequiredPropertyException("HeartbeatArgs", "enabled");
            }
            if ($.interval == null) {
                throw new MissingRequiredPropertyException("HeartbeatArgs", "interval");
            }
            if ($.intervalUnit == null) {
                throw new MissingRequiredPropertyException("HeartbeatArgs", "intervalUnit");
            }
            return $;
        }
    }
