...
@CustomType
public final class IntegrationActionAddNoteFilterCondition {
    ...
    private IntegrationActionAddNoteFilterCondition() {}
    ...
    public static Builder builder(IntegrationActionAddNoteFilterCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer order;
        public Builder() {}
        public Builder(IntegrationActionAddNoteFilterCondition defaults) {
        ...
        public Builder field(String field) {
            if (field == null) {
              throw new MissingRequiredPropertyException("IntegrationActionAddNoteFilterCondition", "field");
            }
            this.field = field;
            return this;
        }
        ...
        public Builder operation(String operation) {
            if (operation == null) {
              throw new MissingRequiredPropertyException("IntegrationActionAddNoteFilterCondition", "operation");
            }
