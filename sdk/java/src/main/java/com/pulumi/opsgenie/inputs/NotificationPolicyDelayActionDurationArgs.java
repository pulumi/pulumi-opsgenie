...
public final class NotificationPolicyDelayActionDurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final NotificationPolicyDelayActionDurationArgs Empty = new NotificationPolicyDelayActionDurationArgs();
    ...
    private NotificationPolicyDelayActionDurationArgs() {}

    private NotificationPolicyDelayActionDurationArgs(NotificationPolicyDelayActionDurationArgs $) {
    ...
    public static Builder builder(NotificationPolicyDelayActionDurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NotificationPolicyDelayActionDurationArgs();
        }

        public Builder(NotificationPolicyDelayActionDurationArgs defaults) {
            $ = new NotificationPolicyDelayActionDurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NotificationPolicyDelayActionDurationArgs build() {
            if ($.timeAmount == null) {
                throw new MissingRequiredPropertyException("NotificationPolicyDelayActionDurationArgs", "timeAmount");
            }
            return $;
        }
    }
