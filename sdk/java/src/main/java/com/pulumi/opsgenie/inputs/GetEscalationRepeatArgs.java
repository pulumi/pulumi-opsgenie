...
public final class GetEscalationRepeatArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetEscalationRepeatArgs Empty = new GetEscalationRepeatArgs();
    ...
    private GetEscalationRepeatArgs() {}

    private GetEscalationRepeatArgs(GetEscalationRepeatArgs $) {
    ...
    public static Builder builder(GetEscalationRepeatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetEscalationRepeatArgs();
        }

        public Builder(GetEscalationRepeatArgs defaults) {
            $ = new GetEscalationRepeatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetEscalationRepeatArgs build() {
            return $;
        }
    }
