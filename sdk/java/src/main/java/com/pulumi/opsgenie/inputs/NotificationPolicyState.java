...
public final class NotificationPolicyState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="filters")
    private @Nullable Output<List<NotificationPolicyFilterArgs>> filters;
     ...
     * 
     */
    public Optional<Output<List<NotificationPolicyFilterArgs>>> filters() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder filters(@Nullable Output<List<NotificationPolicyFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }
