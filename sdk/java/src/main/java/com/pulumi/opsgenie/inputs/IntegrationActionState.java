...
public final class IntegrationActionState extends com.pulumi.resources.ResourceArgs {

    public static final IntegrationActionState Empty = new IntegrationActionState();
    ...
    private IntegrationActionState() {}

    private IntegrationActionState(IntegrationActionState $) {
    ...
    public static Builder builder(IntegrationActionState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntegrationActionState();
        }

        public Builder(IntegrationActionState defaults) {
            $ = new IntegrationActionState(Objects.requireNonNull(defaults));
        }
        ...
        public IntegrationActionState build() {
            return $;
        }
    }
