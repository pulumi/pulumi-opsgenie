...
public final class IntegrationActionAcknowledgeFilterCondition {
    ...
    public static final class Builder {
        ...
        public Builder field(String field) {
            if (field == null) {
              throw new MissingRequiredPropertyException("IntegrationActionAcknowledgeFilterCondition", "field");
            }
            this.field = field;
            return this;
        }
        ...
        public Builder operation(String operation) {
            if (operation == null) {
              throw new MissingRequiredPropertyException("IntegrationActionAcknowledgeFilterCondition", "operation");
            }
        ...
        public IntegrationActionAcknowledgeFilterCondition build() {
            final var _resultValue = new IntegrationActionAcknowledgeFilterCondition();
