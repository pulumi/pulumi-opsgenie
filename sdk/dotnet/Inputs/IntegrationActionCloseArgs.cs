...
namespace Pulumi.Opsgenie.Inputs
{
    ...
    public sealed class IntegrationActionCloseArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("filters")]
        private InputList<Inputs.IntegrationActionCloseFilterArgs>? _filters;
        ...
        /// </summary>
        public InputList<Inputs.IntegrationActionCloseFilterArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.IntegrationActionCloseFilterArgs>());
            set => _filters = value;
        }
